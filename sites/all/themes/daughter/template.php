 ...
 * folder, Drush will think it is trying to daughter core when it is invoked
 ...
 * @see _daughter_theme()
 */
//function daughter_theme(&$existing, $type, $theme, $path) {
// return _daughter_theme($existing, $type, $theme, $path);
//}

function daughter_system_powered_by(){
 ...
 */
//daughter_include('daughter', 'theme/alter.inc');
