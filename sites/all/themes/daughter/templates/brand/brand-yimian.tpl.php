...
$block_brand_qianjinyimian = block_load('block', '6');
$block_brand_qianjinyimian_output = drupal_render(_block_get_renderable_array(_block_render_blocks(array($block_brand_qianjinyimian))));
?>
<div id="company_profile" >
    <div class="container">
        <div class="brand-left">
            <div class="brand-left-img">
                <img src="<?php print $base_path.$theme ?>/images/home/home_yimian.jpg" 
        ...
        <div class="brand-right" >
            <div  class="brand-right-content" style="">
                <div  style="">
                    <div class="brand_logo brand_logo_yimian"></div>
                    <div class="brand_title brand_title_yimian">千金医棉</div>
                </div>
                <div class="brand_qianjinyaomian_content">
                    <?php print $block_brand_qianjinyimian_output; ?>
                </div>
